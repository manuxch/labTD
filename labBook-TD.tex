...
\newexperiment{experimento}{Experimento}
\newexperiment{medicion}{Medición sobre muestra}
\newexperiment{nota}{Nota}
\newexperiment{tabla}{Tabla}
...
\begin{center}
\HRule \\[0.4cm]
{\Huge \bfseries Registro de Laboratorio \\[0.5cm] \Large Mediciones térmicas y dieléctricas}\\[0.4cm] % Degree
\HRule \\[1.5cm]
\end{center}
}
\author{\Huge Ramiro Irastorza, Jesús Fajardo, \\[0.5cm] \Huge Manuel Carlevaro, Fernando Vericat \\ \\ \LARGE rirastorza@iflysib.unlp.edu.ar \\[2cm]} % Your name and email address
\date{Inicio 2 de junio de 2015} % Beginning date
\maketitle
...
%----------------------------------------------------------------------------------------
\labday{Martes, 2 de junio 2015}
\experiment{nota} [Manuel]
